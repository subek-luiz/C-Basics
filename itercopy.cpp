// itercopy.cpp
// uses iterators from copy() algorithm
#include <iostream>
#include <vector>
#include <algorithm>
using namespace std;
...
int main()
{
    ...
    iter3 = copy(iter1, iter2, v2.begin());// copy range from v1 t v2
    // iter3 -> last item copied

    iter1 = v2.begin();         // iterate through range

    while (iter1 != iter3)      // in v2, diplaying values
        cout << *iter1++ << ' ';
